...
function (_Component) {
  ...
  _createClass(item, [{
    ...
    value: function render() {
      return (//   < Query query={SINGLE_ITEM_QUERY} variables={{ id: "cjnvheriq3i3h099503fekewb" }}>
        //     {({ data, loading }) => {
        //       if (loading) return (<p>...Loading</p>);
        //       if (error) return (<p>No item found for id </p>);
...
//# sourceMappingURL=item.js.06f62323412ca3a1e964.hot-update.js.map