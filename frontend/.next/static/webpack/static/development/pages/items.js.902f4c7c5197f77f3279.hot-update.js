...
function (_Component) {
  ...
  function DeleteItem() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "update", function (cache, payload) {
      console.log(cache, payload); //read cache data
      ...
      console.log(data);
      var update_data = data.items.filter(function (item) {
        item.id !== payload.data.deleteItem.id;
      });
      console.log(update_data); // remove the deleted file from cache
      //push data to cache
    });
...
//# sourceMappingURL=items.js.902f4c7c5197f77f3279.hot-update.js.map